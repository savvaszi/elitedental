...
if [ -n "${JWT_PUBLIC_KEY}" ]; then
  ...
  # Priority 1: Check persistent key file (survives infrastructure updates and restarts)
  if [ -f ".devcontainer/.jwt-public-key" ]; then
  ...
  # Priority 2: Check legacy .phantomwp-key file (old injection method)
  ...
  # Priority 3: If still not found, show error
